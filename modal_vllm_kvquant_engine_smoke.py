...
app = modal.App("vllm-kvquant-engine-smoke-v2")
...
def run_engine_smoke_test() -> None:
    ...
    print("=" * 78)
    print("Custom kvquant_k3 end-to-end vLLM engine smoke test")
    print("=" * 78)
    ...
    print()
    print("KVQUANT_K3 MULTI-TOKEN ENGINE SMOKE TEST PASSED")
    print(
