...
BACKUP = Path(tempfile.gettempdir()) / "rabit2_final_perf_backup" / "rabit_kv2.py"
...
LOG = ROOT / "results" / "performance" / "deployment_reproduced.log"
...
def main():
    print("RABIT-2 FINAL targeted performance cycle 鈥?fast exact decode append")
